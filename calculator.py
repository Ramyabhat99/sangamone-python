#tkinter is used to build gui in python
from tkinter import *
root=Tk()
...
def btn_click(item):
    global expression    #global expression is used to modify variables outside the scope
...
#input frame where all widget reside
input_frame = Frame(root, width = 312, height = 50, bd = 0, highlightbackground = "black", highlightcolor = "black", highlightthickness = 1)
input_frame.pack(side = TOP) #pack is  geometry manager packs widgets relative to the earlier widget
...
ne = Button(btns_frame, text = "1", fg = "black", width = 10, height = 3, bd = 0, bg = "#fff", cursor = "hand2", command = lambda: btn_click(1)).grid(row = 3, column = 0, padx = 1, pady = 1)
